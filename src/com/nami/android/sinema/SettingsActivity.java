...
public class SettingsActivity extends PreferenceActivity {
	...
	private void setupSimplePreferencesScreen() {
		...
		fakeHeader.setTitle(R.string.pref_header_filter);
		getPreferenceScreen().addPreference(fakeHeader);
		addPreferencesFromResource(R.xml.pref_filter);

		//bindPreferenceSummaryToValue(findPreference("quality_checkbox"));
		bindPreferenceSummaryToValue(findPreference("transfer_method_list"));
		...
		bindPreferenceSummaryToValue(findPreference("rating_list"));
		bindPreferenceSummaryToValue(findPreference("genre_list"));
	}
